  ...
  <div class="container">
   ...
   <div class="container"> 
    <b-row class="my-1">
      ...
      <b-col sm="9">
       <b-form-input disabled v-model="title"></b-form-input>
      </b-col>
    </b-row>
    <b-row class="my-1">
      <b-col sm="3">
      ...
      <b-col sm="9">
        <multiselect  track-by="candidateId" label="candidateNemail" v-model="chosenCandidate" :options="candidates"></multiselect>
      </b-col>
    </b-row>
    <b-row class="my-1">
      <b-col sm="3">
        <label>Basic Salary (THB):</label>
      </b-col>
      <b-col sm="9">
        <b-form-input v-model="basicSalary"></b-form-input>
      </b-col>
    </b-row>
    <b-row class="my-1">
      <b-col sm="3">
    ...
    <b-row class="my-1">
      ...
      <b-col sm="3">
        <b-form-input  type="date"  v-model="startingDate" ></b-form-input>
      </b-col>
    </b-row> 
  ...
  methods: {
    ...
    add() {
      this.isUploading = true
        axios.post('api/placements/', {
          jobId: this.jobId,
          candidateId: this.chosenCandidate ? this.chosenCandidate.candidateId : null,
          basicSalary: this.basicSalary,
          fee: this.fee,
          startingDate: this.formatDate(),
        })
        .then()
