...
<div class="container">
    ...
    <b-row class="my-1">
      ...
      <b-col sm="9">
          <b-form-input type="password" :state="passwordNotEmpty"
...
export default {
 ...
 /*  mode: 'production', */
  ...
  computed: {
    requirementsOK() {
        return  this.confirmPassword.length > 0 && 
                ...
                this.userName.length > 0 ? true : false;
    //   return this.jobtitle.length > 0 ? true : false
    return true 
    },
  ...
  methods: {
    ...
    add() {
      this.pathToElement = 'api/users/change-password';
