<template>
<div>
  <b-modal id="editUser" hide-footer title="Edit user">
    <b-row class="my-1">
      <b-col sm="3">
    ...
    <b-button class="my-btn" id="add" @click="add">
...
<script>
import {BRow, BCol, BButton, BModal, VBModalPlugin, BDropdown} from 'bootstrap-vue';
 ...
 /*  mode: 'production', */
  ...
  methods: {
    setProps(item) {
      ...
      this.recruiterId = item.recruiter ? item.recruiter.Id : 0;
    },
    openDialog() {
    ...
    add() {
      ...
      this.pathToElement = 'api/users/' + this.userName;
