...
<div v-else>
  <div class="container">
      <br>
      <div>
        <h2>Generate Candidate Report</h2>
      </div>              
    </div>
    ...
    <b-row class="my-3">
      ...
      <b-col sm="9">
        <b-form-input disabled v-model="candidateName"></b-form-input>
      </b-col>
    </b-row>    
     <b-row class="my-3">
      <b-col sm="3">
      ...
      <b-col sm="9">
        <multiselect track-by="jobId" label="jobNid" v-model="chosenJob" :options="jobs"></multiselect>
      </b-col>
    </b-row> 
    <b-row class="my-3">
      <b-col sm="3">
    ...
    <b-button class="my-btn" variant="success" size="lg" id="add"  @click="add" :disabled="!readyToGenerate" >
        Generate Report
        <b-spinner v-if="isGenerating" style="width: 2rem; height: 2rem;" > </b-spinner>
    </b-button>
