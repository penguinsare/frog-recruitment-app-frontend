...
<div class="container">
    ...
    <b-row class="my-1">
      <b-col sm="3">
        <label>From Recruiter:</label>
      </b-col>
      <b-col sm="9">
          <b-form-input type="text" disabled aria-describedby="input-live-feedback" v-model="nameNemail"></b-form-input>
      </b-col>
    </b-row>  
     <b-row class="my-1">
      <b-col sm="3">
    ...
    <div class="text-right">
      <b-button class="my-btn" variant="success" size="lg" id="add" @click="add" :disabled="!requirementsOK">Save</b-button>
